...
@Component({
  selector: 'ngx-viewalliedhealth',
  templateUrl: './viewalliedhealth.component.html',
  styleUrls: ['./viewalliedhealth.component.scss']
})
export class ViewalliedhealthComponent implements OnInit {
