...
@Component({
  selector: 'ngx-rejectedreferrals',
  templateUrl: './rejectedreferrals.component.html',
  styleUrls: ['./rejectedreferrals.component.scss']
})
export class RejectedreferralsComponent implements OnInit {
  ...
  ngOnInit(): void {
    // this.rejectedReferralsArray.length = 0;
  }

  viewReferral(referral: any) {
    this.referral.setReferral(referral);
    this.route.navigate(['/pages/rejected-referrals/view-referral']);
